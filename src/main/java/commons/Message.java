...
public class Message {
    ...
    public static final String MESSAGE_NUMBER = "  Now you have %d tasks in the list.";
    ...
    public static String getAddition(Task t, ArrayList<Task> tasks) {
        return buildMessage(BEGIN_DIVIDER, String.format(MESSAGE_ADDED, t),
                String.format(MESSAGE_NUMBER, tasks.size()), END_DIVIDER);
    }
